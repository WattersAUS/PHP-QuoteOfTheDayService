<?php
//
// Program: getAllQuotes.php (2017-08-13) G.J. Watson
//
// Purpose: Retrieve all quotes stored in the system
//
// Date       Version Note
// ========== ======= ====================================================
...
//
    ...
    function processAllQuotesServiceRequest($token) {
        try {
            ...
            if ($id < 0) {
                ...
                $json = buildAllQuotesJSON($server);
    ...
    if($_SERVER['REQUEST_METHOD'] <> "GET") {
        ...
        if (! $_GET["token"] || empty($_GET["token"])) {
            ...
            $json = processAllQuotesServiceRequest($_GET["token"]);
        }
    }
